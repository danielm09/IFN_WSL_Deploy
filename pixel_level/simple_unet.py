...
class UNet(nn.Module):
    def __init__(self, in_channels=36, out_channels=20, init_features=64):
...
class UNet_4blocks(nn.Module):
    def __init__(self, in_channels=36, out_channels=20, init_features=64):
        super(UNet_4blocks, self).__init__()
...
class UNet_2blocks(nn.Module):
    def __init__(self, in_channels=36, out_channels=20, init_features=64):
        super(UNet_2blocks, self).__init__()
